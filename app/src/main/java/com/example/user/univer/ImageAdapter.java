...
public class ImageAdapter extends BaseAdapter {
    ...
    private String[] main = { "Лекция","Отчет","Заметки","Оценки", "Список группы", "Новости"};
    ...
    private Integer[] mThumbIds = {
            R.drawable.icon1a, R.drawable.icon2, R.drawable.icon3, R.drawable.icon4, R.drawable.icon6, R.drawable.icon10,
